  ...
  <html>
    ...
    <body>
      ...
      <div class="head1 hide-on-med-and-up">
        <img class="responsive-img intro" src="../img/cov93.jpg"/>
      </div>
      <div class="container main">
        <div class="row hide-on-small-only">
          <div class="col l12 m12 s12">
            <img class="responsive-img intro" src="../img/cover93.jpg"/>
          </div>
        </div>
        
        <div class="row">
          <div class="col l12 m12 s12 left-align">
            <h4>A Burmese Affaire at Burma Burma</h4>
          </div>
        </div>
        <div class="row">
          <div class="col l12 m12 s12">
              ...
              <div class="card">
                <div class="col m12 l12 s12 partner">
                  <h5>Offer Includes</h5>
                    <ul class="list">
                      <li class="left-align"> A curated Burmese feast </li>
          ...
          <div class="col l7 m7 s12 center-align">
            <div class="card">
                <div class="col m12 s12 l12 hide-on-small-only justify">
                  <h6>Come fall in love as we swoon you away with a traditional Burmese feast at Burma Burma</h6>
                  <p>An experiential evening exploring Burma on a plate curated by Food Talk India</p>
                  <br>
                  <br>
                  <h6>Date: Thursday, 30th June, 2016 <br>
                      Time: 7:30 pm onwards <br>
                      Venue: Burma Burma, Cyber Hub
                      <br>Cost: Rs 750 per head.
                  </h6>
                  <br>
                  <br>
                  <p>Bringing you the culture, authentic taste and cooking from Burma (Myanmar) lovingly prepared from their treasured family recipes, Burma Burma presents rich flavours and aromas in every bite.</p>
                  <br>
                  <p>Fun fact- Its the first ever all-vegetarian Burmese place in town! </p>
                  <br>
                  <p>Be prepared to have your senses blow away with an all vegetarian Burmese Affaire.</p>
            ...
            <div class="col l5 m5 s12 center-align">
              <div class="card">
                <div class="col l12 m12 s12">
                  ...
                  <ul>
                    <li><img src="../img/partners/burma.png" alt=""></li>
                  </ul>
                </div>
              </div>
            </div>
