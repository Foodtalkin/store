  ...
  <html>
    ...
    <body>
      <div class="intro hide-on-med-and-up">
        <img src="../img/cover78.jpg" class="responsive-img">
      </div>
      <div class="container">
        ...
        <div class="row">
          <div class="col s12 m12 l12 center mt-l">
            <h4 class="">#SquaredUpAtWendys with FoodTalkIndia<h4>
          </div>
          <div class="col s12 m10 offset-m1 l10 offset-l1 center">
            <!-- <h5>Hey there tippler!</h5> -->
            <p>#Announcement The much loved American Burger Chain Wendy's Opens in Cyber Hub, Gurgaon</p>
            <p>Food Talk India is looking for 60 awesome folks to join us for a super fun evening of Burger's , games and lot's more Wendy's Fun this Wednesday, 20th April <br>
            Come get #SquaredUpAtWendys with Food Talk India
            </p> 
            <p><u>Participate below and win an invite for 2</u></p>
          </div>
