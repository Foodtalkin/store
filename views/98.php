        ...
        <div class="row mb0">
          <div class="col s12 m6 l6 center details">
            <img src="../img/cover98.jpg" alt="" class="responsive-img">
              ...
              <h5>That's right folks! Taco Bell is all grown up and we are inviting 50 Food Talkers to come in with their friends and celebrate the all new Taco Bell.  <br>Register with us and stand a chance to get invited!</h5>
              <div class="borderbox">
              ...
              <div class="col s12 m11 l11 offset-m1 offset-l1">
                <form action="" id="frm">
                  ...
                  <div class="col s12 m12 l12 mt20">
                    ...
                    <input type="text" id="response" name="response" class="validate imp">
                  </div> -->
                  <h4 class="center highlights">#GetOnTheList</h4>
                  <div class="col s12 m12 l12 mt20">
