      ...
      <div class="container">
        <div class="row mb0">
          <div class="col s12 m6 l6 center details">
            <div class="hide-on-small-only"><img src="../img/cover111.png" alt="" class="responsive-img"></div>
            <div class="hide-on-med-and-up"><img src="../img/cover111.png" alt="" class="responsive-img"></div>
              <div class="col s12 m12 l12 padd20">
                <h2 class="brand-heading"> Pizza Express Festive Eats</h2>
                <h4 class="brand-heading">Join us for a Delightful Treat</h4>
                <div class="borderbox">
                    <h4 class="center">Date: Friday, 16th December</h4>
                  <h4 class="center">Time: 8pm onwards </h4>
                  <h4 class="center">Venue: Pizza Express, Ambiance Mall Vasant Kunj</h4>  
                  </div>
                
                <h5>Spreading some festive cheer and warmth, Pizza express is all set to launch their  new Festive menu- filled with all things warm and cosy. </h5>
                <h5>Come join us for the launch of the all new Festive menu.</h5>
                  <h5>Have you been Naughty or Nice?</h5>
                  <h5>RSVP and stand a chance to get invited for the feast- our table is set for 30.</h5>
          ...
          <div class="col s12 m6 l6 form">
            <div class="row mb0">
              <div class="col s12 m11 l11 offset-m1 offset-l1"> 
                <h4 class="center highlights">RSVP now</h4>
                <form action="" id="frm"> 
