          ...
          <div class="col l7 m7 s12 center-align">
            <div class="card">
                <div class="col m12 s12 l12 hide-on-small-only justify">
                     <p>Food Talk India is celebrating all the fabulous women.</p> 
                    <p>Ladies join us for a fabulous meal & some Chandon Cocktails and raise a toast to yourself.</p>  
                    <p>
                      Date: Tuesday, 8th March'16 | 8:30 pm <br>
                      Price: Rs 1,000 Ai / Per head <br>
                      Location: Information after booking(Hint: Lutyens' Delhi)
                    </p>
                    <p>Mystery Meal: We promise to take you on a mysterious & fun gastronomic journey to some of our favourite finds in the city.</p>
                      <p>Where are we Dining?</p> 
                      <p>Want to go around Asia in a meal? This quirky all-day dining cafe is the perfect place to go to. Keeping up with its legacy, this restaurant has made note that its bold flavours go hand in hand with the vibrant ambience!</p>  
                </div>
