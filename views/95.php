<?php
   ...
   $user =(array) $_SESSION['USER']['result'];
    ...
    $link = "https://www.instamojo.com/foodtalk/crafternoon-brunch-at-fio?embed=form&data_name=";
    $link .= $user['name'];
    $link .= "&data_email=";
    $link .= $user['email'];
    // $link .= "&data_phone=";
  ...
  <html>
    ...
    <body>
      ...
      <div class="head1 hide-on-med-and-up">
        <img class="responsive-img intro" src="../img/cov95.jpg"/>
      </div>
      <div class="container main">
        <div class="row hide-on-small-only">
          <div class="col l12 m12 s12">
            <img class="responsive-img intro" src="../img/cover95.jpg"/>
          </div>
        </div>
              ...
              <div class="card">
                <div class="col m12 l12 s12 partner">
                  <h5>Offer Includes</h5>
                    <ul class="list">
                      <li class="left-align"> A delicious Sunday Brunch menu by Fio Cookhouse & Bar </li>
          ...
          <div class="col l7 m7 s12 center-align">
            <div class="card">
                <div class="col m12 s12 l12 hide-on-small-only justify">
                  ...
                  <p>Staying true to our theme for the day- we're even got a special Hoegaarden craft cocktail menu!</p>
                  <p>Crafternoon Brunch!</p>
                  <h6>Date: Sunday, 24th July, 2016 <br>
                      Time: 12:30 pm onwards <br>
                      Venue: Fio, Nehru Place
                      <br>Cost: Rs 1,500Ai per head.
                  </h6>
            ...
            <div class="col l5 m5 s12 center-align">
              <div class="card">
                <div class="col l12 m12 s12">
                  ...
                  <ul>
                    <li><img src="../img/partners/fio.png" alt=""></li>
