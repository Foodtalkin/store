<?php
   ...
   $user =(array) $_SESSION['USER']['result'];
    ...
    $link = "https://www.instamojo.com/foodtalk/talkin-asian-at-dimcha?embed=form&data_name=";
    $link .= $user['name'];
    $link .= "&data_email=";
    $link .= $user['email'];
    // $link .= "&data_phone=";
  ...
  <html>
    ...
    <body>
      ...
      <div class="head1 hide-on-med-and-up">
        <img class="responsive-img intro" src="../img/cov96.jpg"/>
      </div>
      <div class="container main">
        <div class="row hide-on-small-only">
          <div class="col l12 m12 s12">
            <img class="responsive-img intro" src="../img/cover96.jpg"/>
          </div>
        </div>
        
        <div class="row">
          <div class="col l12 m12 s12 left-align">
            <h4>Talkin' Asian at Dimcha</h4>
          </div>
        </div>
        <div class="row">
          <div class="col l12 m12 s12">
              ...
              <div class="card">
                <div class="col m12 l12 s12 partner">
                  <h5>Offer Includes</h5>
                    <ul class="list">
                      <li class="left-align"> A beautiful curated Tasting menu</li>
                        <!-- <li class="left-align">Our Favourite Craft Beer- Hoegaarden + Hoegaarden Cocktails</li>
                        <li class="left-align">And some Art & Craft fun- we have a bag full of surprises.</li> -->
                    </ul>
                </div>
              </div>
            </div>
          ...
          <div class="col l7 m7 s12 center-align">
            <div class="card">
                <div class="col m12 s12 l12 hide-on-small-only justify">
                  <h5>Let's Talk Asian At Dimcha</h5>
                  <!-- <h6>Let's get Crafty together!</h6> -->
                  <br>
                  <p>All day everyday is a good time to Talk Asian and who better to Talk Asian with than Food Talk. </p>
                  <p>We're giving you a treat this Thursday! Join us for a delicious Tasting menu at Dimcha. We'll take you to a FlavourGasm like you've never experienced before!</p>
                  <p><strong>Talkin' Asian at Dimcha</strong></p>
                  
                  <h6>Date:  28th July, 2016 <br>
                      Time: 8:00 pm onwards <br>
                      Venue:  Dimcha, Epicuria, Nehru Place
                      <br>Cost: Rs 950 Ai per head.
                  </h6>
                ...
                <div class="col m12 s12 l12 flow-text hide-on-med-and-up justify">
                  ...
                  <h6>Date: Sunday, 24th July, 2016 <br>
                      Time: 12:30 pm onwards <br>
                      Venue:  Dimcha, Epicuria, Nehru Place
                      <br>Cost: Rs 950 Ai per head.
                  </h6>
                ...
                <div class="col l12 s12 m12 address">
                  ...
                  <div class="col l11 m11 s11 right left-align">
                    <h6>  Dimcha, Epicuria, Nehru Place</h6>
                  </div>
                </div>
            </div>
          </div>
